...
Maximal setup for a Django project with Docker, following
...
It's a boilerplate, you can use it as a base to
start a project.
...
Installing command:
```
$ pip install pydjango
```

Create new django application
```bash
create_django folder_name
```
Done
```
*Now your Django app is setting up
